...
const slides = [
  {
    ...
    cards: [
      { title: "Our next merch design", body: "We’re launching new merchandise and want our community to decide what goes live." },
      { title: "This or That?", body: "Pick one option and help settle the debate in seconds." },
      { title: "Pick a Flavor", body: "Vote for your favorite. The winning option goes into production and you earn royalties" },

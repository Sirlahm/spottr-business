...
import contactLady from "../../assets/contact-lady.png";
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <div className="flex items-start gap-3">
                        <input
                            ...
                            onChange={handleChange}
                            className="mt-1 w-[15px] h-[15px] rounded border-white/30 bg-white/20 text-[#274B89] focus:ring-2 focus:ring-white/50 cursor-pointer"
                            required
                        />
                        <label
                            htmlFor="agreePolicy"
